...
public class CompanyBackgroud extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CompanyBackgroud frame = new CompanyBackgroud();
	...
	public CompanyBackgroud() {
		...
		CustomerPageLabel.setIcon(new ImageIcon("C:\\Users\\LEGION\\OneDrive\\Desktop\\ICON\\CompanyBackgroud.jpg.png"));
